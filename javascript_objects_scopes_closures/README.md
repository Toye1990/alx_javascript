This project is a javascript project that i am going to gain alot from. I am looking forward to use the knowledge garnered from this course to create an interactive and responsive website and app.
